...
var editUrl=ls.el||'';if(editUrl){c.each(function(){if($(this).find('img').length>0){return;}
if($(this).next('.vk-ltc-edit-link').length>0){return;}
var editLabel=(vkLtc.editLabel||'Edit');var $editLink=$('<a>').addClass('vk-ltc-edit-link').attr('href',editUrl).css({'font-size':'0.75em','margin-left':'0.5em','white-space':'nowrap',}).text('['+editLabel+']');$(this).after($editLink);});}}}catch(e){}});});},false);